...
export interface UmbralApi {
     ...
     */
    encrypt(pubKey: Uint8Array, plainTextBytes: Uint8Array): Promise<UmbralEncryptionResult>;
    /**
     ...
     */
    generateKeyFragments(chainId: string, receiverPublicKey: Uint8Array, threshold: number, shares: number): Promise<UmbralKeyFragment[]>;
    /**
     ...
     */
    decrypt(chainId: string, capsuleBytes: Uint8Array, cipherTextBytes: Uint8Array): Promise<Uint8Array>;
    /**
     ...
     */
    decryptReEncrypted(chainId: string, senderPublicKey: Uint8Array, capsule: Uint8Array, capsuleFragments: Uint8Array[], cipherTextBytes: Uint8Array): Promise<Uint8Array>;
    /**
     ...
     */
    verifyCapsuleFragment(capsuleFragment: Uint8Array, capsule: Uint8Array, verifyingPublicKey: Uint8Array, senderPublicKey: Uint8Array, receiverPublicKey: Uint8Array): Promise<boolean>;
}
